...
<html>
  ...
  <body>
    <!--this is used for navigation bar on top made by ankit-->
      ...
      <h3 align="right"><font color="white">Hello, <?php echo $_SESSION["enrollment"]?></font></h3>
    <form action="./questionconnect" method="post">
...
<?php
                    ...
                    echo ('<meta http-equiv="refresh" content="0; URL=index?login=incorrect">');
                }
?>
